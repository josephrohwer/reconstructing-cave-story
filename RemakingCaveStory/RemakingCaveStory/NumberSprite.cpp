...
NumberSprite::NumberSprite(Graphics& graphics, int number, int num_digits) : padding_(0.0f)
{
	assert(number >= 0);
	int digit_count = 0;
	do
	{
		...
		reversed_digits_.push_back(boost::shared_ptr<Sprite>(new Sprite(graphics,
			"TextBox",
